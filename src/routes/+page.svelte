<script>
    ...
    import Proimg from "$lib/man.gif";
    import Basimg from "$lib/basket.gif";
    import callimg from "$lib/call.gif";
    import watchimg from "$lib/watch.gif";
    import productimg from "$lib/product.gif";
    import svelteimg from "$lib/svelte-horizontal.svg";
    import supaimg from "$lib/supabase-logo.png";
                ...
                <div class="hidden lg:flex lg:gap-x-12">
                    <div>
                        ...
                        >
                            Templates
                            <svg
                                class="{open ? "rotate-180 transition-all duration-200":"transition-all duration-200 "} h-5 w-5 flex-none text-white"
                                viewBox="0 0 20 20"
                                fill="currentColor"
                                aria-hidden="true"
                            >
                        ...
                        >
                            <div class="mx-auto grid max-w-7xl grid-cols-4 gap-x-4 px-6 py-10 lg:px-8 xl:gap-x-8">
                                {#each allData.products as item}
                                    <div class="group relative rounded-lg p-6 text-sm leading-6 hover:bg-gray-900 bg-gradient-to-r from-indigo-600/20 to-indigo-900/20">
                                        <div
                                        ...
                                        <a href={item.link} class="mt-6 block font-semibold text-gray-400 hover:text-white">
                                            {item.name}
                            ...
                            <div class="bg-gradient-to-r from-indigo-600/20 to-indigo-900/20">
                                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                                    <div class="grid grid-cols-3 divide-x divide-gray-900/5 border-x border-gray-900/5">
                                        <a
                                            href="/"
                                            class="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-white hover:bg-gray-900/20"
                                        >
                                            <img src={watchimg} class="h-11 w-11 flex-none" alt="">
                                            Watch demo
                                        </a>
                                        <a
                                            href="/"
                                            class="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-white hover:bg-gray-900/20"
                                        >
                                        <img src={callimg} class="h-11 w-11 flex-none" alt="">
                                            Contact sales
                                        </a>
                                        <a
                                            href="/"
                                            class="flex items-center justify-center gap-x-2.5 p-3 text-sm font-semibold leading-6 text-white hover:bg-gray-900/20"
                                        >
                                        <img src={productimg} class="h-11 w-11 flex-none" alt="">
                                            View all products
                                        </a>
                                    </div>
                                </div>
    ...
    <main>
      ...
      <div class="relative isolate overflow-hidden bg-gray-900 pb-16 pt-14 sm:pb-20">
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div class="mx-auto grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-5">
            <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1" src={svelteimg} alt="Transistor" width="158" height="48">
            <img class="col-span-2 max-h-12 w-full object-contain lg:col-span-1" src={supaimg} alt="Reform" width="158" height="48">
        ...
        <div class="mx-auto flex max-w-7xl flex-col items-center gap-x-8 gap-y-10 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
          <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
            <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
              <img class="absolute inset-0 h-full w-full rounded-2xl bg-gray-800 object-cover shadow-2xl" src="https://i.pinimg.com/564x/b7/e6/e9/b7e6e9fd0efa2a936d1d847ed2507fa9.jpg" alt="">
            </div>
          </div>
      ...
      <div class="relative isolate mt-32 sm:mt-56 sm:pt-32">
        <svg class="absolute inset-0 -z-10 hidden h-full w-full stroke-gray-200 [mask-image:radial-gradient(64rem_64rem_at_top,white,transparent)] sm:block" aria-hidden="true">
          ...
          <svg x="50%" y="0" class="overflow-visible fill-gray-800">
